 ...
 * @LastEditTime: 2024-11-15 11:00:07
 * @LastEditors: 韩宏广
...
const Heade = () => {
  ...
  const store = useSelector((store) => store.UserReducer.userInfo);
  ...
  return (
    <>
      ...
      >
        <Breadcrumb items={currentRoutingInfo}></Breadcrumb>
        <div className="userInfo">
          ...
          <Popover
            ...
            title={' '}
            content={
              <Button type="link" onClick={personalInfo}>
                退出
              </Button>
            }
            trigger="click"
