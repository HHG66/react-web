...
const ConsumptionManagement = lazy(
  () => import('@/pages/ConsumptionManagement')
);
...
const BalancepaymentsMgement = lazy(
  () => import('@/pages/BalancepaymentsMgement')
);
const ExportBill = lazy(() => import('@/pages/ExportBill'));
const PaymentplanManagement = lazy(
  () => import('@/pages/PaymentplanManagement')
);
const BalancepaymentsImportBill = lazy(
  () => import('@/pages/BalancepaymentsImportBill')
);
...
const Routers = [
  {
    ...
    subs: [
      ...
      },
      {
        ...
        subs: [
          {
            key: '/consumptiontype/management',
            title: '消费类型管理',
      ...
      },
      {
        ...
        subs: [
          {
            key: '/investmentmanagement/funds',
            title: '基金',
            component: lazyCompent(<Funds></Funds>),
            role: '5-1',
          },
          {
            key: '/investmentmanagement/stock',
            title: '股票',
            component: lazyCompent(<Stock></Stock>),
            role: '5-2',
          },
          {
            key: '/investmentmanagement/deposits',
            title: '定期存款',
            component: lazyCompent(<Deposits></Deposits>),
            role: '5-3',
          },
        ],
      },
      ...
      },
      {
        ...
        subs: [
          {
            key: '/checkInformation/summary',
            title: '账单汇总',
            component: lazyCompent(<Summary></Summary>),
            role: '6-1',
          },
          {
            key: '/checkInformation/exportbill',
            title: '导出账单',
            component: lazyCompent(<ExportBill></ExportBill>),
            role: '6-2',
          },
        ],
      },
